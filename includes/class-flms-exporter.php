...
class FLMS_Exporter {
    ...
    public function flms_export_page() {
        ?><div class="wrap">
            ...
            <?php $user_export_in_progress = get_option('flms_user_export'); 
                $user_export_in_progress = get_option('flms_user_export');
                if ( 'is_complete' == get_transient( 'flms_export_complete' ) ) {
                   
                } else if($user_export_in_progress != '') {
                    echo '<div class="notice notice-success is-dismissible">';
                        echo '<p>User data export in progress. '.$user_export_in_progress.' complete.</p>';
                    echo '</div>';
                } ?>
                            ...
                            <div>
                                ...
                                <div class="flms-field select">
                                    <select name="import-type" id="export-type">
                                        ...
                                        <?php if ($user_export_in_progress != '') {
                                            echo ' disabled="disabled"';
                                        } ?>
                                        >User Data <?php if($user_export_in_progress != '') { echo '(In progress)'; } ?></option>
