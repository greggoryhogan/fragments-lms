                ...
                foreach($materials as $material) {
                    ...
                    switch($status) {
                        case 'any':
                            ...
                            break;
                        case 'pre-enrollment':
                            if($user_course_status == 'pre-enrollment') {
                                $display_material = true;
                            }
                            break;
                        case 'post-enrollment':
                            if($user_course_status == 'enrolled' || $user_course_status == 'completed') {
                                $display_material = true;
                            }
                            break;
                        case 'post-completion': 
                            if($user_course_status == 'completed') { //$user_course_status == 'pre-enrollment' || $user_course_status == 'enrolled' || 
                                $display_material = true;
                            }
                            break;
                    }
    ...
    public function flms_course_materials() {
        ...
        if(apply_filters('flms_display_course_materials_label', true)) {
            ...
            echo '<div>';
                ...
                echo implode($sep,$course_material_output);
            echo '</div>';
        echo '</div>';
    }
